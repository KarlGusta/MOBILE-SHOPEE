                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="qty d-flex pt-2">
                                    <div class="d-flex font-rale w-25">
                                        ...
                                        <input type="text" class="qty-input border px-2 w-100 bg-light" disabled
                    ...
                    <div class="col-sm-3">
                        <div class="sub-total border text-center mt-2">
                            ...
                            <div class="border-top py-4">
                                <h5 class="font-baloo font-size-20">Subtotal(2 items): &nbsp; <span
                                        class="text-danger">$</span><span class="text-danger" id="deal-price">152</span>
                                </h5>
